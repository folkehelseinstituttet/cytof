...
#posNegPath <- fs::path("F:", "Forskningsprosjekter", "PDB 2794 - Immune responses aga_", "Forskningsfiler", "JOBO", "CyTOF","Analyse i R OUS", "Resultat_Panel_2", "Data")
library(ggplot2)
library(betareg)
...
outPath <- fs::path("F:", "Forskningsprosjekter", "PDB 2794 - Immune responses aga_", "Forskningsfiler", "JOBO", "CyTOF","Analyse i R OUS", "Resultater til manuel gating panel 2")
...
surrface <- readxl::read_excel(fs::path(outPath, "Panel 2 manual gating updated.xlsx"))
...
colnames(surrface)[colnames(surrface) == "CTL-4"] <- "CTLA-4"
