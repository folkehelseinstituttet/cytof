...
g <- gridExtra::grid.arrange(plot_list[[1]], plot_list[[2]],
  ...
  time_signal_plots <- time_signal_plot(data = beads_data, random_events = random_events_for_plotting, 
                                        channel = "Ce140Di",  plot_title = file_names_in_plot, upper_gate = upper_gate_Ce140Di)
  ...
  density_plots <- density_plot(data = beads_data, channel = "Ce140Di", plot_title = file_names_in_plot, upper_gate = upper_gate_Ce140Di, maksCellsUsed = 25000)
  ...
  #update lower_gate_percent, upper_gate_percent
  center_gates <- find_gaussian_gates_second_top(data = clean_up_data, channel = "Center", lower_gate_percent = 18, upper_gate_percent = 18)
  density_plots <- density_plot(data = clean_up_data, "Center", plot_title = file_names_in_plot, lower_gate = center_gates$lower_gate, upper_gate = center_gates$upper_gate, maksCellsUsed = 25000)
  #density_plots
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Center", plot_title = file_names_in_plot, lower_gate = center_gates$lower_gate, upper_gate = center_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  density_plots <- density_plot(data = clean_up_data, "Offset", plot_title = file_names_in_plot, lower_gate = offset_gates$lower_gate, upper_gate = offset_gates$upper_gate, maksCellsUsed = 25000)
  #density_plots
  ...
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Offset", plot_title = file_names_in_plot, lower_gate = offset_gates$lower_gate, upper_gate = offset_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  #update lower_gate_percent, upper_gate_percent
  width_gates <- find_gaussian_gates_highest_top(data = clean_up_data, channel = "Width", lower_gate_percent = 17, upper_gate_percent = 17)
  
  density_plots <- density_plot(data = clean_up_data, "Width", plot_title = file_names_in_plot, lower_gate = width_gates$lower_gate, upper_gate = width_gates$upper_gate, maksCellsUsed = 25000)
  #density_plots
  ...
  print(density_plots)
  dev.off()
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Width", plot_title = file_names_in_plot, lower_gate = width_gates$lower_gate, upper_gate = width_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  density_plots <- density_plot(data = clean_up_data, "Event_length", plot_title = file_names_in_plot, lower_gate = EventGates$lower_gate, upper_gate = EventGates$upper_gate, maksCellsUsed = 25000)
  #density_plots
  ...
  print(density_plots)
  dev.off()
  time_signal_plots <- time_signal_plot(data =  clean_up_data, random_events = random_events_for_plotting, channel = "Event_length", plot_title = file_names_in_plot, lower_gate = EventGates$lower_gate, upper_gate = EventGates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  print(density_plots)
  dev.off()
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Pt194Di", plot_title = file_names_in_plot, lower_gate = cis_gates$lower_gate, upper_gate = cis_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  print(density_plots)
  dev.off()
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Ir191Di", plot_title = file_names_in_plot, lower_gate = Ir191di_gates$lower_gate, upper_gate = Ir191di_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
  ...
  density_plots <- density_plot(data = clean_up_data, "Ir193Di", plot_title = file_names_in_plot, lower_gate = Ir193di_gates$lower_gate, upper_gate = Ir193di_gates$upper_gate, maksCellsUsed = 25000)
  
  
  tiff(fs::path(outFigDensityPath, "fig9_Ir193_gating.tiff"), width = 1200, height = 2000)
  print(density_plots)
  dev.off()
  time_signal_plots <- time_signal_plot(data = clean_up_data, random_events = random_events_for_plotting, channel = "Ir193Di", plot_title = file_names_in_plot, lower_gate = Ir193di_gates$lower_gate, upper_gate = Ir193di_gates$upper_gate)
  #time_signal_plots # to see all plots
  #time_signal_plots[1] # to see first plot
