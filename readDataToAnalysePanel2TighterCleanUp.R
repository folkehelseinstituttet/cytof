...
outPath <- fs::path("F:", "Forskningsprosjekter", "PDB 2794 - Immune responses aga_", "Forskningsfiler", "JOBO", "CyTOF", "Analyse i R OUS", "Resultat_Panel_2")
...
# # #meta <- read.table(fs::path(analyseSti, "STATAfil OUS pasienter FINAL 270121.txt"))
...
status[grepl("K1", file_names)] <- "Kontrol"
