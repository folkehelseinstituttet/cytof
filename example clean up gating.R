...
number_of_events_after_width_gating/number_of_events_raw_data * 100 #percent remaining from total
number_of_events_after_width_gating/number_of_events_after_offset_gating * 100 #percent remaining from offset gating
...
number_of_events_after_event_gating/number_of_events_raw_data * 100 #percent remaining from total
number_of_events_after_event_gating/number_of_events_after_width_gating * 100 #percent remaining from width gating
...
number_of_events_after_cis_gating/number_of_events_raw_data * 100 #percent remaining from total
number_of_events_after_cis_gating/number_of_events_after_event_gating * 100 #percent remaining from event gating
...
number_of_events_after_Ir191Di_gating/number_of_events_raw_data * 100 #percent remaining from total
number_of_events_after_Ir191Di_gating/number_of_events_after_cis_gating * 100 #percent remaining from cis gating
