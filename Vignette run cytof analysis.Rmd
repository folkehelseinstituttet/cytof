...
The function make_project_folders() use the packages org form FHI. If you have problems runing this you could rather make the folder structure as below. This structure is needed for the rest of the script to run properly.  
...
When you are happy with your cleanup you only have to run it once, that is why I have written it within a if sentence. 
