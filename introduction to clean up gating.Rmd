...
to see which files that is included in the variable fcs_files:
...
# tiff(fs::path(outFigPath, paste0("fig1_bead_gating.tiff")))
# density_plots
# dev.off()
```
...
```{r}
# tiff(fs::path(outFigPath, paste0("Signal_fig2_residal_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
```
...
# tiff(fs::path(outFigPath, paste0("Signal_fig3_center_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
...
# tiff(fs::path(outFigPath, paste0("fig3_center_gating.tiff")))
# print(density_plots)
# dev.off()
```
...
# tiff(fs::path(outFigPath, paste0("Signal_fig4_offset_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
...
# tiff(fs::path(outFigPath, paste0("fig4_offset_gating.tiff")))
# print(density_plots)
# dev.off()
```
...
It takes the variables
  ...
  * lower_gate_percent: tells where the lower gate is placed. See figure and explanation above, here 2.5 %
  * upper_gate_percent: tells where the upper gate is placed. See figure and explanation above, here 4 %
...
#update lower_gate_percent, upper_gate_percent
  ...
  # tiff(fs::path(outFigPath, paste0("fig5_width_gating.tiff")))
  # print(density_plots)
  # dev.off()
...
# tiff(fs::path(outFigPath, paste0("Signal_fig5_width_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
```
...
#update lower_gate_percent, upper_gate_percent
  ...
  # tiff(fs::path(outFigPath, paste0("fig6_event_gating.tiff")))
  # print(density_plots)
  # dev.off()
  ...
  # tiff(fs::path(outFigPath, paste0("Signal_fig6_event_gating.tiff")))
  # plotSignal(plot_list = time_signal_plots)
  # dev.off()
...
fcs_data <- update_data_based_on_events_to_keep(data = fcs_data, kept_events = events_to_keep_after_event_gating)
  ...
  percent_lost_each_gating[as.character(file_names),"Event_length"] <- number_of_events_after_event_gating/number_of_events_before_width_gating * 100 #percent remaining from width gating
```
...
# }
  ...
  # tiff(fs::path(outFigPath, paste0("fig7_cis_gating.tiff")))
  # print(density_plots)
  # dev.off()
  ...
  # tiff(fs::path(outFigPath, paste0("Signal_fig7_cis_gating.tiff")))
  # plotSignal(plot_list = time_signal_plots)
  # dev.off()
```
...
density_plots
# tiff(fs::path(outFigPath, paste0("fig8_Ir191_gating.tiff")))
# print(density_plots)
# dev.off()
...
# tiff(fs::path(outFigPath, paste0("Signal_fig8_Ir191_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
```
...
# tiff(fs::path(outFigPath, paste0("fig9_Ir193_gating.tiff")))
# print(density_plots)
...
# tiff(fs::path(outFigPath, paste0("Signal_fig9_Ir193_gating.tiff")))
# plotSignal(plot_list = time_signal_plots)
# dev.off()
```
