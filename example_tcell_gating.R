...
#density_plots
time_signal_plots <- time_signal_plot(data = arcsinhexprData, random_events = random_events_for_plotting, channel = "CD3", plot_title = file_names,  lower_gate = CD3_pos_gate$lower_gate, upper_gate = CD3_pos_gate$upper_gate)
#time_signal_plots # to see all plots
#time_signal_plots[1] # to see first plot

events_to_keep_after_CD3pos_gating <- events_to_keep(data = arcsinhexprData, channel = "CD3", lower_gate = CD3_pos_gate$lower_gates, 
                                            upper_gate = CD3_pos_gate$upper_gate)
# for(i in 1:length(events_to_keep_after_CD3pos_gating)){
#   print(table(events_to_keep_after_CD3pos_gating[[i]]))
# }
...
#density_plots
time_signal_plots <- time_signal_plot(data = arcsinhexprData, random_events = random_events_for_plotting, channel = "CD19", 
...
plots <- signal_signal_just_plot(data = arcsinhexprData, random_events = random_events_for_plotting, 
