 ...
 * o is optional, but must be included if  you want a different order of your channels in the heatmap. 
 * 
...
print("cluster")
  ...
  write.csv2(q25_k, fs::path(utSti, paste0("25_per_kluster_k_", k, "_seed", params$seed, ext_name, ".csv")))
  ...
  write.csv2(q95_k, fs::path(utSti, paste0("q95_per_kuster_k_", k, "_seed", params$seed, ext_name, ".csv")))
print("q")
...
print("median")
  ...
  tiff(fs::path(utSti, paste0("heatmap_median_k_", k, "_cluster_seed", seed, ext_name, ".tiff")), width = 1000, height = 800)
    Heatmap(as.matrix(medians_k[,params$o], cluster_columns = params$column_cluster))
  dev.off()
print("heatmap")
